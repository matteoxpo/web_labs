  ...
  <nav class="py-2 fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        ...
        <li class="nav-item"><a href="#" class="nav-link px-2">Газировочки</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Энергетики</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Карачинская</a></li>
